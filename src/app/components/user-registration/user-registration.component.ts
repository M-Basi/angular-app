...
export class UserRegistrationComponent {
  ...
  registrationStatus: {success: boolean, messsage: string} = {
    success: false,
    messsage: "Not attempted yet"
  }
  ...
  registerAnother() {
      this.form.reset();
      this.registrationStatus = {success:false, messsage: "Not attempted yet"}      
  }
  ...
  checkOnSubmit() {
    ...
    if(email) {
      this.userService.check_duplicate_email(email).subscribe({
        ...
        error: (response) => {
          console.log("WRONG WONG", response.error.msg)
        }
      })
    }  
  }
